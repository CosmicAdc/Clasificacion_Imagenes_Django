"""
URL configuration for Pr4_SVM_CNN project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="API para predicción de imagenes",
      default_version='v1',
      description="Es el API para predicción de imagenes",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="andresbloc1@gmail.com"),
